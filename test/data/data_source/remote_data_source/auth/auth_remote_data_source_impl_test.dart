...
import 'package:flowery/data/api/auth_api/api_manger.dart';
...
void main() {
  late MockApiManger mockApiManger;
  late AuthRemoteDataSourceImpl authRemoteDataSource;

  setUp(() {
    mockApiManger = MockApiManger();
  ...
  group("forgotPassword", () {
    ...
    test("should return fail message when forgotPassword is Failure", () async {
      ...
      expect((result as Fail<String?>).exception.toString(), contains(testFailMessage));
    });
  });
